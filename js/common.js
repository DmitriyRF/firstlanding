$(document).ready(function() {
	...
	$("a.scroll").click(function() {
		$.scrollTo($(".div"), 800, {
			offset: -90//для прокрутки что бы не заслонять меню часть верха блока
		});
	});
	...
	function carousel_1() {
		...
		owl.owlCarousel({
		items:1,//Количество элементов 
	    autoplay:true,//автопрокрутка
    	autoplayTimeout:2000,//Время прокрутки
    	autoplayHoverPause:true,//Пауза при наведении
	    margin:7,//Белая полоса между слайдами
	    //nav:true,//Добавляет кнопки для переключения
	    ///autoHeight:true,//Автовысота
	    //autoWisth: true,//Автоширина использовать не для сетки
	    ...
	    //responsive:false,
	    //mergeFit:true
	    //video: true, //<a class="owl-video" href="https://www.youtube.com/"></a>
	    /*responsive:{
        	1400:{  items:2, center:true }//responsive up 1400px
    	}*/
		});
